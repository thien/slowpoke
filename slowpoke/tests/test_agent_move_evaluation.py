...
from slowpoke.agents.slowpoke import Slowpoke
from slowpoke.agents.geodude import Geodude
from slowpoke.agents.human import Human
...
def get_all_agents():
    ...
    agents.append(("Slowpoke", Slowpoke(ply_depth=2, use_mlx=False)))

    # Geodude - MCTS player
    agents.append(("Geodude", Geodude(ply_depth=2)))
