...
from library.core.checkers import CheckerBoard, Black, White
...
def run(ply=12, base_round=300, n_games=5):
    ...
    print(f"  rounds/move = {base_round * ply:,}  "
          f"batch_size = 512")
    print(f"{'='*80}")
    ...
    for g in range(n_games):
        ...
        off_all.append(r)
        print(f"  Game {g+1:>2d}/{n_games}: {r['moves']:>2d} moves, "
